...
exports.add_client = (req, res) => {
    const {client_name, contact_principal, raison_sociale, adresse, numTelephone, email, RIB, RC, MF, site_web, Code_TVA} = req.body
    if(!client_name || !contact_principal || !raison_sociale || !adresse || !numTelephone || !email){
